...
// - Controller로부터 받은 요청 데이터에 대해서 필요햇 따라 Repository등을 거쳐 연산을 진행하고 Controller의 응답에 대한 데이터를 반환

// @Service : 해당 클래스를 Spring Bean으로 등록하는 어노테이션, 역할은 @Component와 동일
// @component : 해당 클래스를 Spring Beab으로 등록하는 어노테이션
// Spring Bean : 제어의 역전을 통해서 의존성 주입 시 해당 클래스의 인스턴스를 Spring Framework가 제어하는 요소
@Service
